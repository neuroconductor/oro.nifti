...
#' @section Methods: \describe{ \item{from = "anlz", to = "nifti"}{An object of
#' class \code{anlz} is coerced into a NIfTI object.} \item{from = "array", to
#' = "anlz"}{An object of class \code{array} is coerced into an ANALYZE
#' object.} \item{from = "array", to = "nifti"}{An object of class \code{array}
#' is coerced into a NIfTI object.} \item{from = "list", to = "anlz"}{All
#' objects of class \code{array} in the list are coerced into ANALYZE objects.
#' All other objects are left alone.  The original list structure is retained.}
