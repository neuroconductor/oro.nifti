...
#' @export
#' @rdname xyzt_units-methods
#' @aliases xyzt.units, xyzt.units-methods
...
#' @export
setMethod("xyzt.units", "anlz", function(object) { object@"xyzt.units" })
...
#' @aliases xyzt.units<-,nifti-method
#' @export
setMethod("xyzt.units<-", signature(object="nifti"), 
          function(object, value) { "xyzt_units<-"(object, value) })
#             if ( "xyzt_units" %in% slotNames(object) ){
#               object@"xyzt_units" <- value
#               audit.trail(object) <-
#                 niftiAuditTrailEvent(object, "modification", match.call(),
